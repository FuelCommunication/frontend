...
<template>
    <aside
        class="hidden lg:flex fixed left-0 top-0 h-screen w-20 flex-col items-center border-r z-10"
    >
        <nav
            class="flex-1 flex flex-col items-center gap-2 py-4 overflow-y-auto scrollbar-none"
        >
            ...
            <div
                v-else-if="!subscriptions?.items?.length"
